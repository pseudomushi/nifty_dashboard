...
import { ComprehensiveNewsItem } from "@/lib/marketData";
import { TrendingUp, TrendingDown, Minus, Globe, Flag, TrendingUpIcon } from "lucide-react";

interface ComprehensiveNewsProps {
  internationalNews: ComprehensiveNewsItem[];
  nationalNews: ComprehensiveNewsItem[];
  marketNews: ComprehensiveNewsItem[];
}
...
export default function ComprehensiveNews({
  ...
  const allNews = [...internationalNews, ...nationalNews, ...marketNews].sort(
  ...
  const renderNewsItem = (item: ComprehensiveNewsItem) => (
    <div
      key={item.id}
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h3 className="text-lg font-bold text-gray-900 mb-6">Market News & Global Events</h3>
